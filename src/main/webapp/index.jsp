...
<html>
    <head>
        ...
        <style>
            ...
            .header{
                background:#f9f9f9 url(<%=contextPath%>/image/login/pz-logo.jpg) no-repeat center top;
                background-size:80%;
                z-index: 4;
            }
            body{
                background:#f9f9f9 url(<%=contextPath%>/image/login/login1.jpg) no-repeat center top;
                background-size:80%;
                z-index: 3;
            }
        </style>
